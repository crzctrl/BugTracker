    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var lower = model.Email.ToLower();
                if (user == null || lower == "demoadmin@mailinator.com" 
                                 || lower == "demoprojmgr@mailinator.com"
                                 || lower == "demodeveloper@mailinator.com"
                                 || lower == "demosubmitter@mailinator.com")
                {
                ...
                await EmailHelper.ComposeForgotPasswordEmailAsync(model, callbackUrl);
